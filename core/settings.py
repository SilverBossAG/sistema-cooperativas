...
SECRET_KEY = 'django-insecure-106x-67c0&jh*dx$9l0j5wb(1gb8_)&baqgu#8=l278p3x!a+j'
...
# CONFIGURACIÓN DE CANALES (Modo Desarrollo/Memoria)
CHANNEL_LAYERS = {
    "default": {
...
DATABASES = {
    'default': {
        ...
        'NAME': 'db_cooperativas',  # La que creamos en phpMyAdmin
        'USER': 'root',             # Usuario por defecto de XAMPP
        'PASSWORD': '',             # XAMPP trae la contraseña vacía por defecto
