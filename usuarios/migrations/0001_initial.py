# Generated by Django 4.2.27 on 2025-12-20 17:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('SA', 'Super Admin'), ('PR', 'Presidente Comunidad'), ('VE', 'Vecino')], default='VE', max_length=2, verbose_name='Rol en la comunidad')),
                ('requiere_cambio_pass', models.BooleanField(default=True, verbose_name='Obligar cambio contraseña')),
                ('cooperativa', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='usuarios', to='usuarios.cooperativa', verbose_name='Cooperativa Asignada')),
